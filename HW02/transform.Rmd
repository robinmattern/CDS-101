...
```{r initialization, echo = FALSE, eval = FALSE}
    install.packages("nycflights13")   # .(70928.02.1 RAM Run this manually with CTRL-ENTER)
    install.packages("Lahman")         # .(70928.02.2 RAM Run this manually in the console is quicker)
```

```{bash, echo = FALSE, eval = FALSE}  
                                        # .(70928.02.3 RAM Put your copy of chapter files into a seperate folder) 
    cd "C:/Shared/Users/R.M/Pers/Rebecca/2017/GMU/Data Analysis/CDS/R for Data Science/r4ds" 
    pwd
# Make a folder for this chapter
    mkdir chapters/05 
# Copy required files:  
    cp diagrams/transform*  chapters/05/diagrams 
# Save a copy of this file:  
    cp transform.Rmd  chapters/05/
# Reopen the file, transform.Rmd, and Knit to HTML   
```
...
### 5.5.1 Useful creation functions {#mutate-funs}
...
### 5.6.4 Useful summary functions {#summarise-funs}
